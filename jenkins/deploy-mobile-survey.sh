...
export ssh_command="/usr/bin/ssh -i /keys/infrastructure.pem  ubuntu@survey.eha.io "
function scp_file { /usr/bin/scp -i /keys/infrastructure.pem $1 ubuntu@survey.eha.io:/tmp/; }
